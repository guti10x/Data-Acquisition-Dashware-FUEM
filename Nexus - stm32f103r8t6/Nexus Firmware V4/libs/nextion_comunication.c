...
// Elelementos de la interfaz a actualizar por alerta
...
// Función para actualizar valores de las barras de frenado, aceleración y revoluciones
...
// Función para actualizar los indicadores de revoluciones del dash
...
// Función para actualizar color estado de voltaje batería y temperatura del motor
